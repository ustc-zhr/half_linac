...
class BOOptimizer:
    def __init__(self, func=None, bounds=None, 
                 kernel_type="rbf", acq="ucb", acq_optimizer="ga", 
                 n_init=10, n_iter=50, random_state = 100):
        """
        初始化贝叶斯优化器
        
        参数:
            func: 目标函数 ["sphere", "rosenbrock", "ackley"]
            acq: 采集函数 ["ucb", "ei", "pi"] 
    ...
    def optimize(self):
        ...
        for it in range(self.n_iter):
            ...
            beta = beta_schedule(it, beta0=3.0, strategy="inv_decay", lam=0.05)
