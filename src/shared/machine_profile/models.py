...
def _parse_image_geometry(
    ...
    for backend_name in image_channels:
        ...
        model_to_image_x_sign = backend_geometry.get("model_to_image_x_sign", 1)
        if (
            ...
            raise MachineProfileError(
                f"{location}.image_geometry.{backend_name}.model_to_image_x_sign "
                "must be -1 or 1."
            )
        parsed_backend["model_to_image_x_sign"] = model_to_image_x_sign
