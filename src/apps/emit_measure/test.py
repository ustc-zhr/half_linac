...
ele_file     = st.rootpath+'/src/virtual_machine/half_elegant/elegant/emit_ini.ele'  
filepath     = st.rootpath+"/src/virtual_machine/half_elegant/halflinac.json"
lfile = st.rootpath+'/src/virtual_machine/half_elegant/elegant/emit.lte'
#line_name    = 'ALL' #'use_beamline'
efile     = st.rootpath+'/src/virtual_machine/half_elegant/elegant/emit.ele'  
jpath     = st.rootpath+"/src/virtual_machine/half_elegant/emit.json"
