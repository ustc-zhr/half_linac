...
APP_DEFINITIONS = {
    ...
    "energy_buttons": {
        ...
        "category": "tools",
        "access": "write",
        "button_text": "Q Energy Reference",
        "label": "Q Energy Reference",
        "window_title_patterns": ("HALF · Q Energy Reference",),
        "description": "Adjust HALF L02–L18 energy references. Arrows write immediately and update quadrupole currents through the existing controls.",
        "machine_ids": ("half",),
        "workflow_name": "energy_buttons",
        "cmd": ["python3", "main.py", "--epics"],
    ...
    "ct_monitor": {
        ...
        "description": "Monitor CT signals and calculate ICT transmission efficiency.",
        "workflow_name": "ct_monitor",
        "cmd": ["python3", "main.py"],
