...
if QtWidgets is not None:
    ...
    class ScanPanel(QtWidgets.QWidget):
        ...
        def _build_single_knob_page(self):
            ...
            self.single_intro_label.setStyleSheet("QLabel { color: #475569; }")
        ...
        def _build_random_page(self):
            ...
            self.random_intro_label.setStyleSheet("QLabel { color: #475569; }")
        ...
        def random_configuration(self) -> dict[str, object]:
            ...
            return {
                ...
                "sample_interval_sec": float(self.random_sample_interval_spin.value()),
        ...
        def monitor_configuration(self) -> dict[str, object]:
            return {
                "sample_interval_sec": float(self.interval_spin.value()),
        ...
        def single_knob_configuration(self) -> dict[str, object]:
            return {
                ...
                "sample_interval_sec": float(self.scan_sample_interval_spin.value()),
        ...
        def apply_monitor_configuration(self, config: dict[str, object]) -> None:
            if "sample_interval_sec" in config:
                self.interval_spin.setValue(float(config["sample_interval_sec"]))
        ...
        def apply_single_knob_configuration(self, config: dict[str, object]) -> None:
            ...
            if "sample_interval_sec" in config:
                self.scan_sample_interval_spin.setValue(float(config["sample_interval_sec"]))
        ...
        def apply_random_configuration(self, config: dict[str, object]) -> None:
            ...
            if "sample_interval_sec" in config:
                self.random_sample_interval_spin.setValue(float(config["sample_interval_sec"]))
