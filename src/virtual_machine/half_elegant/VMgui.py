...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_ESAline = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_ESAline.setObjectName("pushButton_ESAline")
        self.gridLayout_5.addWidget(self.pushButton_ESAline, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_ESAline.setText(_translate("MainWindow", "transfer to ESA"))
