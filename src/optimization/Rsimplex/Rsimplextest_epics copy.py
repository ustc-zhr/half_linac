...
class RSimplex:
    ...
    def __init__(self, func, x0=None, vrange=None,
                 noise_level=0.01, M1=1.4, M2=2.0, max_samples=3, rebuild_fraction=0.6,
                 max_iters=1000, max_evaluations=1000,
    ...
    def simplexmain(self, start, step_size=0.1, tol=1e-6):
        """
        执行优化过程
...
if __name__ == "__main__":
    ...
    # 执行优化
    best_point, history = optimizer.simplexmain(start=start_point, step_size=step_size)
