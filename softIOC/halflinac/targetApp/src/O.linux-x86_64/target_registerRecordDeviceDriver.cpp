...
/* Generated from ../O.Common/target.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devLsiEnviron, *pvar_dset_devtargetVersion,
    ...
    *pvar_dset_devWfPDBDemoRepeat, *pvar_dset_devXxxSoft;
...
static const char * const deviceSupportNames[] = {
    ...
    "devLiSoft", "devLiSoftCallback", "devLiGeneralTime", "devLoPDBUTag",
    "devLoSoft", "devLoSoftCallback", "devLsiSoft", "devLsiEnviron",
    "devtargetVersion", "devLsoSoft", "devLsoSoftCallback", "devLsoStdio",
    ...
    "devSoStdio", "devSASoft", "devWfSoft", "devWfPDBDemo",
    "devWfPDBDemoRepeat", "devXxxSoft"
};
...
int target_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/zhanghaoran/project/half_linac/softIOC/halflinac";
...
/* target_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: target_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(target_registerRecordDeviceDriver(*iocshPpdbbase));
}
